function render(){
    let html = '<label>Ingredients:</label>' +
        ...
        '<div class="input-holder"><input class="new-ingredient" placeholder="Add ingredients..."></div>' +
        '<div class="button-holder">' +
        '<button class="add-ingredient-button">Add</button>' +
        '<button class="remove-ingredient-button">Remove</button>' +
        '</div>'+
        '<label>Recipe:</label>' +
        '<div class="input-recipe input-holder"><input type="text" placeholder="Recipe..."></div>';
